...
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNameAdmin --runtim dotnetcore:8.0 --output $azCliOutput
...
Write-host "      ➡️ Create Web App"
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNamePortal --runtim dotnetcore:8.0 --output $azCliOutput
Write-host "      ➡️ Assign Identity"
