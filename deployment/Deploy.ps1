...
az appservice plan create -g $ResourceGroupForDeployment -n $WebAppNameService --sku B2 --is-linux --output $azCliOutput

Write-host "   🔵 Admin Portal WebApp"
Write-host "      ➡️ Create Web App"
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNameAdmin --is-linux --list-runtimes dotnet:8 --output $azCliOutput
...
Write-host "      ➡️ Create Web App"
az webapp create -g $ResourceGroupForDeployment -p $WebAppNameService -n $WebAppNamePortal --is-linux --list-runtimes dotnet:8 --output $azCliOutput
Write-host "      ➡️ Assign Identity"
